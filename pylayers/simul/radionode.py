...
class RadioNode(object):
    """
     A Radio node is either a Transmitter or a Receiver 
    ...
    def __init__(self,_filespa,_fileant,type=0):
        ...
        if type==2:
            ...
            self.save()
        #   
        # Translate into the old format 
        # .. todo::
        #      this is a fix to be removed 
        #
        self.N = len(self.points.keys())
    ...
    def info(self):
        """
            Display Radio Nodes Informations
        """
        print "Npos       : ",self.N
    ...
    def save(self,k=-1):
        """
        Create a .spa file and a .vect file  
