...
def plot_cdf_RSS_TOA():
        for i in range(Ntrial):
                ...
                P1tls=S1.TLSHDFLocate(RN_RSS, RN_TOA, None, None,  ToA, TDoA, PL0, d0, RSS, RSSnp, RSSStd, Rest)
                TLS_vect.append(dist(P1tls,P))
                ...
                P0=L*rand(2,1) 
                P4=S1.MLHDFLocate(P, P0, RN_RSS, RN_TOA, None, None, ToA, ToAStd, TDoA, TDoAStd, PL0, d0, RSS, RSSnp, RSSStd, Rest)
                ML_vect.append(dist(P4,P))

                P5=S1.SDPHDFLocate(RN_RSS, RN_TOA, None, None, ToA, ToAStd, TDoA, TDoAStd, PL0, d0, RSS, RSSnp, RSSStd, Rest)
                SDP_vect.append(dist(P5,P))
...
def plot_cdf_RSS_TDOA():
        for i in range(Ntrial):
                ...
                P1tls=S1.TLSHDFLocate(RN_RSS, None, RN_TDOA, RN_TDOA2, ToA, TDoA, PL0, d0, RSS, RSSnp, RSSStd, Rest)
                TLS_vect.append(dist(P1tls,P))
                
                P2=S1.WLSHDFLocate(RN_RSS, None, RN_TDOA, RN_TDOA2, ToA, ToAStd, TDoA, TDoAStd, PL0, d0, RSS, RSSnp, RSSStd, Rest)
                WLS_vect.append(dist(P2,P))'''

                P2twls=S1.TWLSHDFLocate(RN_RSS, None, RN_TDOA, RN_TDOA2, ToA, ToAStd, TDoA, TDoAStd, PL0, d0, RSS, RSSnp, RSSStd, Rest)
                TWLS_vect.append(dist(P2twls,P))
                
                P0=L*rand(2,1) 
                P4=S1.MLHDFLocate(P, P0, RN_RSS, None, RN_TDOA, RN_TDOA2, ToA, ToAStd, TDoA, TDoAStd, PL0, d0, RSS, RSSnp, RSSStd, Rest)
                ML_vect.append(dist(P4,P))

                P5=S1.SDPHDFLocate(RN_RSS, None, RN_TDOA, RN_TDOA2, ToA, ToAStd, TDoA, TDoAStd, PL0, d0, RSS, RSSnp, RSSStd, Rest)
                SDP_vect.append(dist(P5,P))
...
def plot_cdf_TOA_TDOA():
		...
		while (sum(ToA < 0)) != 0   :
                ...
                P1tls=S1.TLSHDFLocate(None, RN_TOA, RN_TDOA, RN_TDOA2, ToA, TDoA, PL0, d0, RSS, RSSnp, RSSStd, Rest)
                TLS_vect.append(dist(P1tls,P))
                
                P2=S1.WLSHDFLocate(None, RN_TOA, RN_TDOA, RN_TDOA2, ToA, ToAStd, TDoA, TDoAStd, PL0, d0, RSS, RSSnp, RSSStd, Rest)
                WLS_vect.append(dist(P2,P))'''
		print '############### TOA ##################'	
		print 'RNTOA\n', RN_TOA
		print 'ToA\n',ToA
...
#		print 'point:',P2twls
                ...
                P0=L*rand(2,1) 
                P4=S1.MLHDFLocate(P, P0, None, RN_TOA, RN_TDOA, RN_TDOA2, ToA, ToAStd, TDoA, TDoAStd, PL0, d0, RSS, RSSnp, RSSStd, Rest)
...
def plot_cdf_ML_All():
        ...
        for i in range(Ntrial):
                ...
                P4rsstoa=S1.MLHDFLocate(P, P0, RN_RSS, RN_TOA, None, None, ToA, ToAStd, TDoA, TDoAStd, PL0, d0, RSS, RSSnp, RSSStd, Rest)
                MLrsstoa_vect.append(dist(P4rsstoa,P))

                P4rsstdoa=S1.MLHDFLocate(P, P0, RN_RSS, None, RN_TDOA, RN_TDOA2, ToA, ToAStd, TDoA, TDoAStd, PL0, d0, RSS, RSSnp, RSSStd, Rest)
...
def plot_cdf_TWLS_All():
        ...
        for i in range(Ntrial):
                ...
                P4rsstoa=S1.TWLSHDFLocate(RN_RSS, RN_TOA, None, None, ToA, ToAStd, TDoA, TDoAStd, PL0, d0, RSS, RSSnp, RSSStd, Rest)
                TWLSrsstoa_vect.append(dist(P4rsstoa,P))

                P4rsstdoa=S1.TWLSHDFLocate(RN_RSS, None, RN_TDOA, RN_TDOA2, ToA, ToAStd, TDoA, TDoAStd, PL0, d0, RSS, RSSnp, RSSStd, Rest)
                TWLSrsstdoa_vect.append(dist(P4rsstdoa,P))

                P4rsstoatdoa=S1.TWLSHDFLocate(RN_RSS, RN_TOA, RN_TDOA, RN_TDOA2, ToA, ToAStd, TDoA, TDoAStd, PL0, d0, RSS, RSSnp, RSSStd, Rest)
...
def plot_cdf_SDP_RSS_nTOA():
        ...
        ntoa=range(5)
        err_moy=[mean(SDPrss_vect),mean(SDPrss1toa_vect),mean(SDPrss2toa_vect),mean(SDPrss3toa_vect),mean(SDPrss4toa_vect)]
...
if (__name__ == "__main__"):
    ...
    RN_RSS=array([[0.0,L,0.0,L],[0.0,0.0,L,L]])
    RN_TOA=array([[L/3.0,L,2*L/3.0,0.0],[0.0,L/3.0,L,2*L/3.0]])
    RN_TDOA_all=array([[L/2.0,2*L,L/2.0,-L],[-L,L/2.0,2*L,L/2.0]])
    RN_TDOA=array([[2*L,L/2.0,-L],[L/2.0,2*L,L/2.0]])
    RN_TDOA2=RN_TDOA_all[:,0:1]*ones(shape(RN_TDOA))
