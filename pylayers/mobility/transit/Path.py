...
def B0(tt): return tt**3
def B1(tt): return 3 * tt**2 * (1-tt)
def B2(tt): return 3 * tt * (1-tt)**2
def B3(tt): return (1-tt)**3
...
class _Mover(StateProcess):
	...
	def update(self):
		...
		if hasattr(self, 'last_x'):
			tk.canvas.create_line(x_(self.last_x), y_(self.last_y), x_(self.x), y_(self.y))
...
if __name__ == '__main__':
	...
	m.segments = ( Straight((30., 10.), (30., 40.)),
				   ...
				   Spline((90., 150.), (90., 200.), (30., 200.), (30., 150.))
				   )
	m.x, m.y = (75.0, 600.0)
