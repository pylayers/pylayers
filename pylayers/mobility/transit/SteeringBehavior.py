...
class Arrive:
    def calculate(self, boid):
        ...
        slowing_distance = (current_speed /
                            boid.max_acceleration) * (current_speed / 2)
...
class Wander:
    def calculate(self, boid):
        ...
        desired_velocity = (boid.localy.scale(8) + boid.localx.scale(
            wander_value)).normalize() * boid.desired_speed
