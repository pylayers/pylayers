...
#
    ...
    def buildGt_old(self, check=True):
        ...
        for cy in self.Gt.nodes():
            # nx v1.1 lncy = nx.neighbors(self.Gt, cy)
            lncy = self.Gt[cy].keys()
            for ncy in lncy:
    ...
    def buildGi(self,verbose=False,tqdmpos=0):
        ...
        for n in self.Gv.node:
            ...
            if n > 0:  # R | T
                ...
                nei = self.Gs[n].keys()  # get neighbor
                np1 = nei[0]
                np2 = nei[1]
    ...
    def buildGw(self):
        ...
        for e in self.Gr.edges_iter():  # iterator on Gr edges
            ...
            for Id in Ids:
                ...
                unode = self.Gs[Id].keys()  # get edge number of common doors
