...
class SelectL(object):
    ...
    def show(self,clear=False,dnodes=True,dedges=True,dlabels=False,font_size=10,title='Init'):
        """
         show(self,clear=False,dnodes=True,dedges=True,dlabels=True,font_size=10):
        """
    ...
    def call(self):
       ...
       The following keyboard command are available 
        ...
        if self.evt =="l":
            ...
            self.g.display['activelayer'] = multchoicebox('message','titre',listchoices)
            return()
        #
        # e : Edit
        #
        ...
        if self.state=='Init':
            ...
            # select point 1
                ...
                self.pt1       = np.array(self.g.Gs.pos[self.nsel]).reshape(2,1)
                self.pt_previous   = self.pt1
                self.p1        = self.spl.plot([self.pt1[0]],[self.pt1[1]],'o',visible=True)
        ...
        if (self.state=='SP1'):
            ...
            if (self.evt=='lclic') & (self.nsel < 0):
                ...
                # select pt2
                    ...
                    self.p2  = self.spl.plot([self.pt2[0]],[self.pt2[1]],'o',visible=True)
        ...
        if (self.state=='SS'):
            ...
            # create point on edge
                ...
                if (pt_new!=[]):
                    ...
                    self.current_layer = self.g.Gs.node[self.selected_edge]['name']
